...
# Date: 2025-02-07
# Script: bridgit_input_rhea.py
# Description: Prepares rhea reaction data for input into the BridgIT LCSB server.
...
# Paths
input_file = '/scratch/jarcagniriv/Case1-Rhea/Database/smiles_vs_ec_subset_500.tsv'
output_file = '/scratch/jarcagniriv/ECNumberPrediction/methods/BridgIT/input/input_rhea/FormattedReactions.txt'
molfile_folder = '/scratch/jarcagniriv/ECNumberPrediction/methods/BridgIT/input/input_rhea/molfiles'
...
for reaction_id, row in enumerate(df.itertuples(index=False), start=1):
...
# https://lcsb-databases.epfl.ch/Bridgit/GetResults/4573244