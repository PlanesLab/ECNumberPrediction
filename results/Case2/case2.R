...
data_eval <- read_csv("/Users/josefinaarcagni/Downloads/evaluation_summary_case2.csv")
...
# ================================ #
ggsave(
  filename = "/Users/josefinaarcagni/Documents/ECMethods/FinalGraphs/Case2/case2_plot_rhea.png",
