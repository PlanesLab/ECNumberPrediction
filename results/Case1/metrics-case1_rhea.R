...
data_eval <- read_csv(
  "/scratch/jarcagniriv/ECNumberPrediction/results/Case1/evaluation_summary_rhea500.csv",
...
data_topn <- read.csv(
  "/scratch/jarcagniriv/ECNumberPrediction/results/Case1/merged_output_rhea500.csv",
...
ggsave(
  "/scratch/jarcagniriv/ECNumberPrediction/results/Case1/Figures/fig1_rhea.jpg",
  final_plot,
  width  = 20,
  height = 22,
  dpi    = 300,
